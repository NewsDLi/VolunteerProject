...
import com.volunteer.web.controller.login.UserLoginController;
...
//			LOGGER.info("解密内容：{}", AES_decode);
	...
	public static void main(String[] args) {
		...
		String aesEncode = se.AESEncode("qweert", "123123123123");
		System.out.println("加密后的内容："+aesEncode);
		
		String aesDncode = se.AESDncode("qweert", aesEncode);
		System.out.println("解密后的内容："+aesDncode);
	}
}
